const SITE_CONFIG = {
    ...
    name: 'Nexus',
    role: 'C# Developer, Jave Developer, Python Developer',
    summary: 'I used to be a Unturned Plugin Dev made plugins for roleplay Servers, Recently Switch other to making plugins in minecraft not to long ago',
    heroEyebrow: '',
    focusAreas: ['Exams'],
    about: 'I do C#. The Unturned Code i do is rocketmod. I can do advance uis etc',
    availability: '',
    currentFocus: 'Currently focusing on exams',
    location: 'Australia',
    serverUrl: '',
    contactSummary: '',
    stack: [
        { title: 'Languages', items: ['C#'] },
        { title: 'Java', items: ['Paper'] },
        { title: 'Unity', items: ['Advanced UIs'] },
        { title: 'Bot', items: ['Python'] },
    ],
    highlightRepos: [],
    contact: {
        email: '',
